...
<main class="form-signin">
  <form action="formRegister.php" method="post">
    <h1 class="h3 mb-3 fw-normal">Confirm your order</h1>
    ...
    <div class="form-floating">
      ...
      <label for="floatingInput">Country,City,Street</label>
    </div>

    <button class="w-100 btn btn-lg btn-primary" type="submit" name="submit">Make the order</button>
