...
<body onload="displaySelectedFurniture()">


<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="dashboard.php"><?php echo "Welcome to dashboard ".$_SESSION['username']; ?></a>
